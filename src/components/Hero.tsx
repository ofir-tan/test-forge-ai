  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 pt-20 bg-radial-fade">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          <button className="px-8 py-3.5 rounded-md bg-primary text-primary-foreground font-semibold hover:bg-primary/90 transition-all glow-red-intense">
            Start Generating Tests
          </button>
          <button className="px-8 py-3.5 rounded-md border border-border text-foreground font-semibold hover:bg-secondary transition-colors">
            View Demo
          </button>
        </motion.div>
